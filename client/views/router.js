...
var privateRoutes = [
	...
	"admin.users.edit",
	"admin.cameras",
	"admin.cameras.details",
	"admin.cameras.edit",
	"admin.cameras.insert",
	"user_settings",
...
var roleMap = [
	{ route: "home_private",	roles: ["admin","user"] },
	{ route: "admin",	roles: ["admin"] },
	{ route: "admin.users",	roles: ["admin"] },
	{ route: "admin.users.details",	roles: ["admin"] },
	{ route: "admin.users.edit",	roles: ["admin"] },
	{ route: "admin.cameras",	roles: ["admin"] },
	{ route: "admin.cameras.details",	roles: ["admin"] },
	{ route: "admin.cameras.edit",	roles: ["admin"] },
	{ route: "admin.cameras.insert",	roles: ["admin"] },
...
Router.map(function () {
	...
	this.route("admin.cameras", {path: "/admin/cameras", controller: "AdminCamerasController"});
	this.route("admin.cameras.details", {path: "/admin/cameras/details/:cameraId", controller: "AdminCamerasDetailsController"});
	this.route("admin.cameras.edit", {path: "/admin/cameras/edit/:cameraId", controller: "AdminCamerasEditController"});
	this.route("admin.cameras.insert", {path: "/admin/cameras/insert", controller: "AdminCamerasInsertController"});
